      ...
      <section className="py-5">
        <Container className="py-5">
          <Tabs defaultActiveKey="profile" id="uncontrolled-tab-example" className="mb-3">
            ...
            <Tab eventKey="approval" title="Aprobar proyectos">
              <Container>
                <Card className="px-4 my-5">
                  <Card.Body>Aprobar Proyectos</Card.Body>
                </Card>

                {/* Aquí puedes añadir el contenido relacionado con la aprobación de proyectos */}
                <p>Contenido para aprobar proyectos.</p>
              </Container>
            </Tab>
          </Tabs>
        </Container>
